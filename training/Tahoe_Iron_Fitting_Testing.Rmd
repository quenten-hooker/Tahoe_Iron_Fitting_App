...
ggplot(Data.Sum, aes(x = BallSpeedMph.mean)) + geom_histogram(color = "black", fill = "grey", bins = 50) + geom_density(aes(y = ..density.. *44000), color = "red", adjust = 2)

ggplot(Data.Sum, aes(x = BallLaunchAngleDeg.mean)) + geom_histogram(color = "black", fill = "grey", bins = 50) + geom_density(aes(y = ..density..*12200), color = "red", adjust = 2)


ggplot(Data.Sum, aes(x = BallBackSpinRpm.mean)) + geom_histogram(color = "black", fill = "grey", bins = 50) + geom_density(aes(y = ..density..*4100000), color = "red", adjust = 2)
